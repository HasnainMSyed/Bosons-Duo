...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="blue")) as demo:
    ...
    gr.Markdown("Enter the topic you want the AI agents to discuss and optionally upload a context document.")
    ...
    with gr.Row(): # Use Rows and Columns for layout control
        ...
        with gr.Column(scale=2): # Central column for inputs
            ...
            next_step_button = gr.Button("Next: Configure Agents ➡️", variant="primary")
            
        # Empty column on the right
        gr.Column(scale=1) 

    # --- Placeholder for Next Steps ---
    # We will add more UI sections here later, initially hidden
